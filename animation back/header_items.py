...
# 2.83 max
  ...
  a = int (4.0 * x)
  a = ibf_armor_mask & x
  y = (((bignum | a) & ibf_armor_mask) << ibf_head_armor_bits)
  return y

# def head_armor(x):
 # y = (int(round (x, 0)))
 # return (((bignum | y) & ibf_armor_mask) << ibf_head_armor_bits)
...
itc_cleaver = itcf_force_64_bits | (itcf_thrust_onehanded|itcf_slashright_onehanded|itcf_slashleft_onehanded |
                                    itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_thrust_onehanded)

itc_dagger  = itc_cleaver | itcf_overswing_onehanded
...
itc_staff      = itc_parry_polearm| itcf_thrust_onehanded_lance | itcf_overswing_onehanded | itcf_thrust_onehanded_lance_horseback| itcf_overswing_polearm |itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm
itc_spear      = itc_parry_polearm| itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm
itc_cutting_spear = itc_spear|itcf_overswing_onehanded
